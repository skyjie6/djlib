...
import com.skyjie.djlib.view.NinePatchActivity;
...
public class CustomViewActivity extends ListActivity {
    private String[] mTitles = { "圆角drawable", "发送验证码按钮", "气泡view", "PulldownViewActivity", "StretchViewActivity", "srollowView", "lottleView", "chatTextview", "9切"};
